! function(t) {
    "use strict";
	t("#umumno-galal-mlebu").on("click", function(i) {
        t.NotificationApp.send("Gagal!", "Mungkin surel dan sandi yang anda masukkan salah, silahkan ulangi kembali.", "bottom-left", "rgba(0,0,0,0.2)", "error")
    }),
